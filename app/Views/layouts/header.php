<?php
// caminho base do projeto, uso isso nos links de menu e nos assets.
// se mudar o nome da pasta no htdocs tem que atualizar aqui tambem
...
<head>
    ...
    <!-- precisa carregar antes dos scripts de cada pagina -->
